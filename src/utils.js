...
const data = {
    ...
    asia: {
        ...
        countryExample: {
            name: "China",
            description: "Experience the beauty and rich culture of China. From the iconic Great Wall and Terracotta Army to the bustling streets of Beijing, there's something for everyone to discover. Immerse yourself in the ancient traditions and modern advancements of the world's most populous country."
        }
    },
    america:{
