...
function MainPage() {
    ...
    return (
        <>
            ...
            <ContinentCard continentImage={Africa} title="Africa" description={descriptions.africa}/>
            <ContinentCard continentImage={Europe}  title="Europe" description={descriptions.europe}/>
            <ContinentCard continentImage={Asia}  title="Asia" description={descriptions.asia}/>
            <ContinentCard continentImage={America} title="America" description={descriptions.america}/>
            </div>
        </>
